...
gpg --quiet --batch --yes --decrypt --passphrase="$APPLE_ENCRYPTION_PASSPHRASE" --output ./.github/secrets/ios_development.p12 ./.github/secrets/ios_development.p12.gpg
gpg --quiet --batch --yes --decrypt --passphrase="$APPLE_ENCRYPTION_PASSPHRASE" --output ./.github/secrets/ios_distribution.p12 ./.github/secrets/ios_distribution.p12.gpg
